 ...
 * @version 1.0
 */
 include 'copychangname.php';
/**
 * Define database parameters here
 */
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'nets1305');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'C:\xampp\htdocs\filewedsite\test_test'); // Comment this line to use same script's directory ('.')
define("BACKUP_FILE", listname(directorylistArray('../test_test', true)) ); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
...
class Restore_Database {
    ...
    protected function initializeDatabase() {
        try {
            ...
            // mysqli_query($conn, "CREATE DATABASE ".$this->dbName);
